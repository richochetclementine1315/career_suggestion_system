...
class_names=['Lawyer(CLAT,AILET,etc)', 'Doctor(NEET)', 'Government Officer(UPSC,SSC CGL,etc)', 'Artist(CUET)', 'Unknown',
        'Software Engineer(JEE,WBJEE,MHT CET,etc)', 'Teacher(TET)', 'Business Owner', 'Scientist(IAT)',
        'Banker(MBA)', 'Writer', 'Accountant(CA exam)', 'Designer(CEED)',
        'Construction Engineer(JEE,WBJEE,etc)', 'Game Developer', 'Stock Investor',
